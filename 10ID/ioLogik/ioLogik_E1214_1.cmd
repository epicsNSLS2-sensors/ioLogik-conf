...
drvModbusAsynConfigure("$(E12xx_ASYNPORT)_DI", "$(E12xx_ASYNPORT)", 0, 2, 0, 6, 0, 100, "ioLogik")
...
drvModbusAsynConfigure("$(E12xx_ASYNPORT)_DO", "$(E12xx_ASYNPORT)", 0, 5, 0, 6, 0, 1, "ioLogik")

# MOXA E12xx DOs: function 1 (Read Coils), address 0, length 6, data_type = UINT16 = 0, 
# pollMsec = for read func, waits XXX msecs
drvModbusAsynConfigure("$(E12xx_ASYNPORT)_DO_RBV", "$(E12xx_ASYNPORT)", 0, 1, 0, 6, 0, 100, "ioLogik")

## Load record instances
dbLoadRecords("db/ioLogik_E1214.db","Sys=$(SYSNAME), Dev=$(DEV), ASYNPORT=$(E12xx_ASYNPORT)")
