...
/* Generated from ../O.Common/ioLogik.dbd */
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiFloat64Average", "devAiStats", "devAiClusts", "devAoSoft",
    "devAoSoftRaw", "devAoSoftCallback", "asynAoInt32", "asynAoFloat64",
    "devAoStats", "asynRecordDevice", "devBiSoft", "devBiSoftRaw",
    ...
    "devStringinEnvVar", "devStringinEpics", "devSoSoft",
...
int ioLogik_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/epics/iocs/ioLogik";
...
/* ioLogik_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"ioLogik_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    ioLogik_registerRecordDeviceDriver(*iocshPpdbbase);
}
